...
function firstRepeatedFrequency() {
  while(1) {
    for(let i = 0; i < input.length; i++) {
      total += input[i];
  
      if(frequencies.find((frequency) => frequency === total)) {
        return total;
      }   
